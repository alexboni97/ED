...
public:
  ...
  void append(ListLinkedSingle &other);
...
*/
void ListLinkedSingle::append(ListLinkedSingle&other){
  if(other.head!=other.head->next){

  head->prev=other.head->next;
  other.head->next=head->prev;
